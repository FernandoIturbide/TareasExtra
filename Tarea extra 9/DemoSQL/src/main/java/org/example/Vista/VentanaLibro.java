...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(49, 180, 184));
        lblID=new JLabel("ID:");
        ...
        panel2.setBackground(new Color(133, 50, 189));
        ...
        panel3.setBackground(new Color(175, 49, 184));
        //panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(159, 184, 49));
